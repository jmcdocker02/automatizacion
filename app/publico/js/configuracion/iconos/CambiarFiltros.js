...
export async function CambiarFiltros(e){
  ...
  switch(e.target.id){
    ...
    case "id-guardar":
      ...
      break;
    case "id-Modificar":
      await MostrarModal(e.target.getAttribute("data-ico01"))
      break;
    case "id-Eliminar":
      await Eliminar(e.target.getAttribute("data-ico01"));
      break;
  }
  switch (e.target.parentNode.id) {
    ...
    case "id-guardar":
      ...
      break;
    case "id-Modificar":
      await MostrarModal(e.target.parentNode.getAttribute("data-ico01"))
      break;
    case "id-Eliminar":
      await Eliminar(e.target.parentNode.getAttribute("data-ico01"));
      break;
  }
}