...
import { AreaTexto } from "../componentes/AreaTexto.js";
import { BotonesExportarCancelar } from "../funciones/BotonesExportarCancelar.js";
import { GeneraArchivoTexto } from "../funcionesExcel/GeneraArvhivoTexto.js";

export async function ModalErrores(AJson){ // Parametro id de registro que se esta generando en caso de que sea 0 o mostrando en caso de que sea diferente de 0
  const {
    idTabla,
  ...
  Modal({ // Funcion modal que se encarga de mostrar la modal en la SPA
    "titulo": "Errores de proceso", // titulo de la modal en cuestion, este parametro es necesario que se modifique
    ...
    "botones": BotonesExportarCancelar( // Botones o booton que se va a mostrar en el pie de la modal, por default se usa esta funcion pero si cambia el requerimiento se puede modificar a un solo boton usando el componente boton
      [{
        "atributo": "data-id",
        "valor": idTabla,
      }]
